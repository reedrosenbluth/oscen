...
pub struct Delay {
    #[input(stream)]
    pub input: f32,       // Runtime value - direct access!
    ...
    #[output(stream)]
    pub output: f32,      // Runtime value - direct access!
...
impl SignalProcessor for Delay {
    ...
    /// Auto-generated by macro, but we override to add parameter updates and call our process().
    fn process<'a>(&mut self, sample_rate: f32, context: &mut ProcessingContext<'a>) -> f32 {
        ...
        // Get value inputs and update parameters
        ...
        Delay::process(self, sample_rate)
    }
}

// process_internal() is auto-generated by #[derive(Node)]
