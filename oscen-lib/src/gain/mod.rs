...
// SignalProcessor is auto-generated by #[derive(Node)] macro!
// The macro populates stream fields (input) and value fields (gain) from context,
// then calls Gain::process(). No manual implementation needed!
