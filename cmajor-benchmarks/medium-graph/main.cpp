...
void runBenchmark()
{
    ...
    std::string cmajorCode = loadFile("MediumGraph.cmajor");

    cmaj::ProgramInterface program;
    program.name = "MediumGraph";
    program.mainProcessor = "MediumGraph";
    ...
    std::cout << "=== Cmajor Medium Graph (2 osc + filter + env) ===" << std::endl;
