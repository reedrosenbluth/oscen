...
impl SineOsc {
    ...
    pub fn with_hz(tag: Tag, hz: In) -> Self {
        Self { tag, hz, amplitude: fix(1.0), phase: fix(0.0) }
    }
...
impl SquareOsc {
    ...
    pub fn with_hz(tag: Tag, hz: In) -> Self {
        Self { tag, hz, amplitude: fix(1.0), phase: fix(0.0), duty_cycle: fix(0.5) }
    }
